...
class Solution {
	func maxSubArray(_ nums: [Int]) -> Int {
		...
		for i in 1..<nums.count {
			...
			subArraySum = max(nums[i], nums[i] + subArraySum)
...
//
//			var stride = nums.count
//
//			if i != 0 {
//				stride = (Int((nums.count)/i))
//				stride = nums.count - i 
//			}
//
//			for j in (0..<stride).reversed() {
//
//				let actualMaxSum = Array(nums[j...j+i]).reduce(0,+)
//
